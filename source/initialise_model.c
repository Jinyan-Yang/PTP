...
void initialise_control(control *c) {
    ...
    */
    ...
    c->alloc_model = GRASSES;    /* C allocation scheme: FIXED, GRASSES, ALLOMETRIC */
    ...
    c->water_balance = BUCKET;            /* Water calculations: 0=simple 2 layered bucket; 1=SPA-style hydraulics */

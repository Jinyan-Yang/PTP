            ...
            params *p, state *s)
{
    ...
    */
    ...
    } else if (MATCH("params", "green_sw_frac")) {
	p->green_sw_frac = atof(value);
	} else if (MATCH("params", "days_rain")) {
	p->days_rain = atof(value);
	}
